...
import { Tooltip, TooltipContent, TooltipTrigger } from "@browse-dot-show/ui";
...
export function ThemeToggle({ themeConfig }: ThemeToggleProps) {
  const { theme, toggleTheme } = useTheme(themeConfig);
